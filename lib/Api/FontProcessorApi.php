...
class FontProcessorApi
{
     ...
     * @param  \Aurigma\AssetProcessor\Model\AurigmaAssetProcessorWebApiEnumsFontPreviewFormat $preview_settings_format preview_settings_format (optional)
     ...
     * @param  \Aurigma\AssetProcessor\Model\AurigmaAssetProcessorWebApiEnumsFontPreviewHorizontalAlignment $preview_settings_horizontal_alignment preview_settings_horizontal_alignment (optional)
     * @param  \Aurigma\AssetProcessor\Model\AurigmaAssetProcessorWebApiEnumsFontPreviewVerticalAlignment $preview_settings_vertical_alignment preview_settings_vertical_alignment (optional)
     ...
     * @param  int $preview_settings_height Preview image heigth. (optional)
     * @param  string $preview_settings_text Text, that will be visualized with selected font in preview image, e.g. &#39;Abg&#39;. (optional)
     * @param  \Aurigma\AssetProcessor\Model\AurigmaAssetProcessorWebApiEnumsFontPreviewFormat $preview_settings_format (optional)
     * @param  int $preview_settings_max_width Max width of preview image  If parameter is set then normal widht and height and font size are ignored. (optional)
     * @param  float $preview_settings_font_size Font size for text visualization in preview image. (optional)
     * @param  \Aurigma\AssetProcessor\Model\AurigmaAssetProcessorWebApiEnumsFontPreviewHorizontalAlignment $preview_settings_horizontal_alignment (optional)
     * @param  \Aurigma\AssetProcessor\Model\AurigmaAssetProcessorWebApiEnumsFontPreviewVerticalAlignment $preview_settings_vertical_alignment (optional)
     * @param  string $preview_settings_background Background color for preview image. (optional)
     * @param  string $preview_settings_text_color Text color for preview image. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['fontProcessorImportFont'] to see the possible values for this operation
     *
     ...
     * @param  AurigmaAssetProcessorWebApiEnumsFontPreviewFormat $format Preview image format (optional)
     ...
     * @param  AurigmaAssetProcessorWebApiEnumsFontPreviewHorizontalAlignment $horizontal_alignment Horizontal alignment of text visualization in preview image (optional)
     * @param  AurigmaAssetProcessorWebApiEnumsFontPreviewVerticalAlignment $vertical_alignment Vertical alignment of text visualization in preview image (optional)
