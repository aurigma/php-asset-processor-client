<?php
/**
 * AurigmaAssetProcessorWebApiModelsDesignCreateBlankDesignModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AurigmaAssetProcessorWebApiModelsDesignCreateBlankDesignModel Class Doc Comment
 *
 * @category Class
 ...
 */
class AurigmaAssetProcessorWebApiModelsDesignCreateBlankDesignModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Aurigma.AssetProcessor.WebApi.Models.Design.CreateBlankDesignModel';
    ...
    protected static $openAPIFormats = [
        ...
        'blank_design_source_settings' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'blank_design_source_settings' => 'blankDesignSourceSettings'
    ];
    ...
    protected static $setters = [
        ...
        'blank_design_source_settings' => 'setBlankDesignSourceSettings'
    ];
    ...
    protected static $getters = [
        ...
        'blank_design_source_settings' => 'getBlankDesignSourceSettings'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('blank_design_settings', $data ?? [], null);
        $this->setIfExists('blank_design_source_settings', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets design_params
     *
     * @return \Aurigma\AssetProcessor\Model\AurigmaAssetProcessorWebApiModelsDesignDesignParamsModel
     */
    ...
    public function setDesignParams($design_params)
    {
        if (is_null($design_params)) {
            throw new \InvalidArgumentException('non-nullable design_params cannot be null');
        }
     ...
     *
     * @return \Aurigma\AssetProcessor\Model\AurigmaAssetProcessorWebApiModelsDesignBlankDesignSettingsModel
     */
    ...
    {
        if (is_null($blank_design_settings)) {
            throw new \InvalidArgumentException('non-nullable blank_design_settings cannot be null');
        }
    ...
    {
        return $this->container['blank_design_source_settings'];
    }
