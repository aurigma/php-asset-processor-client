...
class CreateDesignFromMockupModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets design_params
     *
     * @param \Aurigma\AssetProcessor\Model\DesignParamsModel $design_params Design prameters.
     *
     * @return self
     */
    ...
    public function setMockupId($mockup_id)
    {
        ...
        if ((mb_strlen($mockup_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mockup_id when calling CreateDesignFromMockupModel., must be bigger than or equal to 1.');
        }
