...
/**
 * AurigmaAssetProcessorWebApiModelsDesignCopyDesignFromPublicDesignModel Class Doc Comment
 *
 * @category Class
 ...
 */
class AurigmaAssetProcessorWebApiModelsDesignCopyDesignFromPublicDesignModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Aurigma.AssetProcessor.WebApi.Models.Design.CopyDesignFromPublicDesignModel';
    ...
    {
        $this->setIfExists('public_design_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['public_design_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'public_design_id', the character length must be bigger than or equal to 1.";
        }
    ...
    {
        if (is_null($public_design_id)) {
            throw new \InvalidArgumentException('non-nullable public_design_id cannot be null');
        }

        if ((mb_strlen($public_design_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $public_design_id when calling AurigmaAssetProcessorWebApiModelsDesignCopyDesignFromPublicDesignModel., must be bigger than or equal to 1.');
        }
