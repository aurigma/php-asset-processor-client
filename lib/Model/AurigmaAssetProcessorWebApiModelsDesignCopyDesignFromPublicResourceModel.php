...
/**
 * AurigmaAssetProcessorWebApiModelsDesignCopyDesignFromPublicResourceModel Class Doc Comment
 *
 * @category Class
 ...
 */
class AurigmaAssetProcessorWebApiModelsDesignCopyDesignFromPublicResourceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Aurigma.AssetProcessor.WebApi.Models.Design.CopyDesignFromPublicResourceModel';
    ...
    */
    ...
    public function setPublicResourceId($public_resource_id)
    {
        ...
        if ((mb_strlen($public_resource_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $public_resource_id when calling AurigmaAssetProcessorWebApiModelsDesignCopyDesignFromPublicResourceModel., must be bigger than or equal to 1.');
        }
