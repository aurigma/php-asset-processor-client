<?php
/**
 * AurigmaAssetProcessorWebApiModelsDesignCreateDesignFromMockupModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AurigmaAssetProcessorWebApiModelsDesignCreateDesignFromMockupModel Class Doc Comment
 *
 * @category Class
 ...
 */
class AurigmaAssetProcessorWebApiModelsDesignCreateDesignFromMockupModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Aurigma.AssetProcessor.WebApi.Models.Design.CreateDesignFromMockupModel';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['mockup_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'mockup_id', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setMockupId($mockup_id)
    {
        if (is_null($mockup_id)) {
            throw new \InvalidArgumentException('non-nullable mockup_id cannot be null');
        }

        if ((mb_strlen($mockup_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mockup_id when calling AurigmaAssetProcessorWebApiModelsDesignCreateDesignFromMockupModel., must be bigger than or equal to 1.');
        }
