...
```php
privateDesignProcessorCheck($id, $tenant_id, $user_id): \Aurigma\AssetProcessor\Model\DesignProblemInfo
```
...
try {
    $result = $apiInstance->privateDesignProcessorCheck($id, $tenant_id, $user_id);
    print_r($result);
} catch (Exception $e) {
...
```php
privateDesignProcessorCreateBlankDesign($tenant_id, $user_id, $create_blank_design_model): \Aurigma\AssetProcessor\Model\DesignDto
```
...
try {
    $result = $apiInstance->privateDesignProcessorCreateBlankDesign($tenant_id, $user_id, $create_blank_design_model);
    print_r($result);
} catch (Exception $e) {
...
```php
privateDesignProcessorEmbedDataSchema($id, $tenant_id, $user_id): \Aurigma\AssetProcessor\Model\DesignDto
```
...
try {
    $result = $apiInstance->privateDesignProcessorEmbedDataSchema($id, $tenant_id, $user_id);
    print_r($result);
} catch (Exception $e) {
...
```php
privateDesignProcessorExportDesign($id, $tenant_id, $user_id)
```
...
try {
    $apiInstance->privateDesignProcessorExportDesign($id, $tenant_id, $user_id);
} catch (Exception $e) {
...
```php
privateDesignProcessorExtractDataSchema($id, $tenant_id, $user_id, $design_extract_data_schema_model)
```
...
try {
    $apiInstance->privateDesignProcessorExtractDataSchema($id, $tenant_id, $user_id, $design_extract_data_schema_model);
} catch (Exception $e) {
...
```php
privateDesignProcessorGetDepositPhotos($id, $tenant_id, $user_id): \Aurigma\AssetProcessor\Model\ImageDepositPhoto[]
```
...
try {
    $result = $apiInstance->privateDesignProcessorGetDepositPhotos($id, $tenant_id, $user_id);
    print_r($result);
} catch (Exception $e) {
...
```php
privateDesignProcessorLinkDataSchema($id, $tenant_id, $user_id, $design_link_data_schema_model): \Aurigma\AssetProcessor\Model\DesignDto
```
...
try {
    $result = $apiInstance->privateDesignProcessorLinkDataSchema($id, $tenant_id, $user_id, $design_link_data_schema_model);
    print_r($result);
} catch (Exception $e) {
...
```php
privateDesignProcessorPreparePreview($id, $namespace, $name, $width, $height, $surface_index, $stub, $format, $force, $tenant_id, $user_id): \SplFileObject
```
...
try {
    $result = $apiInstance->privateDesignProcessorPreparePreview($id, $namespace, $name, $width, $height, $surface_index, $stub, $format, $force, $tenant_id, $user_id);
    print_r($result);
} catch (Exception $e) {
...
```php
privateDesignProcessorPreparePreviewUrl($id, $namespace, $name, $width, $height, $surface_index, $stub, $format, $force, $tenant_id, $user_id): string
```
...
try {
    $result = $apiInstance->privateDesignProcessorPreparePreviewUrl($id, $namespace, $name, $width, $height, $surface_index, $stub, $format, $force, $tenant_id, $user_id);
    print_r($result);
} catch (Exception $e) {
...
```php
privateDesignProcessorRemoveDataSchema($id, $tenant_id, $user_id): \Aurigma\AssetProcessor\Model\DesignDto
```
...
try {
    $result = $apiInstance->privateDesignProcessorRemoveDataSchema($id, $tenant_id, $user_id);
    print_r($result);
} catch (Exception $e) {
...
```php
privateDesignProcessorUpdate($id, $tenant_id, $user_id, $design_params_name, $design_params_path, $design_params_custom_fields, $file): \Aurigma\AssetProcessor\Model\DesignDto
```
...
try {
    $result = $apiInstance->privateDesignProcessorUpdate($id, $tenant_id, $user_id, $design_params_name, $design_params_path, $design_params_custom_fields, $file);
    print_r($result);
} catch (Exception $e) {
